...
export const en = {
  nav: {
    ...
    search_button: "Search pages",
    search_dialog_title: "Search",
    search_input_placeholder: "Search pages…",
    search_no_results: "No matches",
    search_hint_navigate: "↑↓ navigate",
    search_hint_select: "↵ select",
    search_hint_close: "esc close",
    section_primary: "Workspace",
    section_secondary: "App",
  },
  usgaap: {
    title: "USGAAP <> IFRS",
    landing_intro:
  ...
  errors: {
    max_files_per_run: "Max {n} files per run",
    upload_failed_status: "Upload failed ({status})",
    export_failed_status: "Export failed ({status})",
    refresh_failed_status: "Refresh failed ({status})",
    load_failed_status: "Load failed ({status})",
